...
function PageWrapper({ children }) {
  return (
    <div className=" tracking-widest  bg-contain md:bg-cover bg-center bg-slate-800 bg-opacity-80 ">
      <div className="h-screen  home_bg">
        <Head>
          <title>PWA</title>
          <meta name="description" content="Generated by create next app" />
          <link rel="icon" href="/favicon.ico" />
        </Head>
        <div className="flex  bg-slate-700 bg-opacity-20 px-2 py-2 w-full">
