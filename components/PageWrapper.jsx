...
function PageWrapper({ children }) {
  return (
    <div className=" tracking-widest  bg-cover overflow-hidden md:bg-cover bg-center bg-slate-800 bg-opacity-80 ">
      <div className="h-screen  bg-no-repeat overflow-hidden home_bg">
        <Head>
          <title>PWA</title>
