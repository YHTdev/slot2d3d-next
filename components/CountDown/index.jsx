...
function Timer({hour,minute}) {
  const Completionist = () => <span className="px-2 border border-slate-800 rounded-lg">done</span>;
...
const renderer = ({ hours, minutes, seconds, completed }) => {
    if (completed) {
      ...
      // Render a countdown
      return <div className="flex flex-row justify-between items-center content-center">
  ...
  return (
    <div>
      <Countdown date={Date.now()+hoursToMilliseconds(hour)+minutesToMilliseconds(minute)} renderer={renderer}>
